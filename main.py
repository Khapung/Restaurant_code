...
class Franchise:
  ...
  def __repr__(self):
    return "The location of our franchise is at " + self.address 
  ...
  def available_menus(self, time):
    ...
    return "Available menus are {}".format(available_menu)
...
early_bird_items = {
 ...
 'pizza with quattro formaggi': 9.00, 'duck ragu': 17.50, 'mushroom ravioli (vegan)':
...
# kids Menu
kids_items = {
  'chicken nuggets': 6.50, 'fusilli with mild mushrooms': 12.00, 'apple juice': 3.00
}
kids_menu = Menu("kid",kids_items , 1100, 2100)
